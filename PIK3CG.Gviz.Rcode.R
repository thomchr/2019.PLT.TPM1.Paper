...
pdf("PIK3CG.10kb.wWGS.locus.pdf")
ub <- loc + 10000
lb <- loc - 10000
plotTracks(list(ot2, ot, grtrack, gtrack), chromosome = chr, from = lb, to = ub, type = "histogram", scale = 0.25, labelPos = 'below', collapseTranscripts = 'meta', transcriptAnnotation = 'gene_name')
dev.off() 
...
pdf("PIK3CG.100kb.WGS.locus.pdf")
ub <- loc + 100000
lb <- loc - 100000
plotTracks(list(WGplt, WGred, grtrack, gtrack), chromosome = chr, from = lb, to = ub, type = "histogram", scale = 0.25, labelPos = 'below', collapseTranscripts = TRUE, shape = "arrow", transcriptAnnotation = 'gene_name')
dev.off() 

pdf("PIK3CG.1Mb.WGS.locus.pdf")
ub <- loc + 1000000
lb <- loc - 1000000
plotTracks(list(ot, grtrack, HSC, CD34, MEP, Ery, gtrack), chromosome = chr, from = lb, to = ub, type = "histogram", scale = 0.25, labelPos = 'below', collapseTranscripts = TRUE, shape = "arrow", transcriptAnnotation = 'gene_name')
dev.off() 
...
pdf("PIK3CG.10kb.locus.atac.pdf")
ub <- loc + 10000
lb <- loc - 10000
plotTracks(list(ot, grtrack, HSC, CD34, MEP, Ery, gtrack), chromosome = chr, from = lb, to = ub, type = "histogram", scale = 0.25, labelPos = 'below', collapseTranscripts = 'meta', transcriptAnnotation = 'gene_name')
dev.off() 
...
#pdf("POLR2L.70kb.SNPsGRMarks.locus.pdf")
...
#pdf("POLR2L.100kb.wWGS.locus.pdf")
...
pdf("POLR2L.100kb.SNPs.GeneRegiononly.locus.pdf")
...
pdf("POLR2L.10kb.locus.pdf")
lb <- loc - 10000
ub <- loc + 10000
plotTracks(list(ot2, grtrack, gtrack), chromosome = chr, from = lb, to = ub, type = "histogram", scale = 0.25, labelPos = 'below', collapseTranscripts = 'meta', transcriptAnnotation = 'gene_name')
dev.off() 

#pdf("POLR2L.1kb.locus.pdf")
...
pdf("POLR2L.1Mb.GRonly.locus.pdf")
...
pdf("POLR2L.1Mb.GRonly.noannotation.locus.pdf")
