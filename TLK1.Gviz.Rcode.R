...
pdf("TLK1.10kb.locus.atac.pdf")
ub <- loc + 10000
lb <- loc - 10000
plotTracks(list(ot, grtrack, HSC, CD34, MEP, Ery, gtrack), chromosome = chr, from = lb, to = ub, type = "histogram", scale = 0.25, labelPos = 'below', collapseTranscripts = 'meta', transcriptAnnotation = 'gene_name')
dev.off() 

pdf("TLK1.10kb.locus.pdf")
ub <- loc + 10000
lb <- loc - 10000
...
#pdf("TLK1.70kb.SNPsGRMarks.locus.pdf")
...
pdf("TLK1.100kb.SNPs.GeneRegiononly.locus.pdf")
...
pdf("TLK1.1Mb.GRonly.noannotation.locus.pdf")
