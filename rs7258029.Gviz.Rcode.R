...
pdf("rs7258029.100kb.wWGS.locus.pdf")
ub <- loc + 100000
lb <- loc - 100000
...
pdf("rs7258029.10kb.wWGS.locus.pdf")
ub <- loc + 10000
lb <- loc - 10000
plotTracks(list(ot2, ot, grtrack, gtrack), chromosome = chr, from = lb, to = ub, type = "histogram", scale = 0.25, labelPos = 'below', collapseTranscripts = 'meta', transcriptAnnotation = 'gene_name')
dev.off() 
...
pdf("rs7258029.100kb.WGS.locus.pdf")
ub <- loc + 100000
lb <- loc - 100000
...
#pdf("rs7258029.70kb.SNPsGRMarks.locus.pdf")
...
pdf("rs7258029.100kb.SNPs.GeneRegiononly.locus.pdf")
...
pdf("rs7258029.1Mb.GRonly.locus.pdf")
...
pdf("rs7258029.1Mb.GRonly.noannotation.locus.pdf")
