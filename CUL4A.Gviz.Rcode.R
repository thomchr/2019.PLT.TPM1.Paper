...
pdf("CUL4A.100kb.wWGS.locus.pdf")
ub <- loc + 100000
lb <- loc - 100000
...
#pdf("CUL4A.70kb.SNPsGRMarks.locus.pdf")
...
pdf("CUL4A.100kb.SNPs.GeneRegiononly.locus.pdf")
...
pdf("CUL4A.1Mb.GRonly.locus.pdf")
...
pdf("CUL4A.1Mb.GRonly.noannotation.locus.pdf")
