...
pdf("ACTN4.100kb.wWGS.locus.pdf")
ub <- loc + 100000
lb <- loc - 100000
...
#pdf("ACTN4.70kb.SNPsGRMarks.locus.pdf")
...
pdf("ACTN4.100kb.SNPs.GeneRegiononly.locus.pdf")
...
pdf("ACTN4.1Mb.GRonly.locus.pdf")
...
pdf("ACTN4.1Mb.GRonly.noannotation.locus.pdf")
