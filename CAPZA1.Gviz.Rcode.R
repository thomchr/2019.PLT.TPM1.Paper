...
pdf("CAPZA1.100kb.wWGS.locus.pdf")
ub <- loc + 100000
lb <- loc - 100000
...
pdf("CAPZA1.10kb.wWGS.locus.pdf")
ub <- loc + 10000
lb <- loc - 10000
plotTracks(list(ot2, ot, grtrack, gtrack), chromosome = chr, from = lb, to = ub, type = "histogram", scale = 0.25, labelPos = 'below', collapseTranscripts = 'meta', transcriptAnnotation = 'gene_name')
dev.off() 
...
pdf("CAPZA1.100kb.WGS.locus.pdf")
ub <- loc + 100000
lb <- loc - 100000
...
#pdf("CAPZA1.70kb.SNPsGRMarks.locus.pdf")
...
pdf("CAPZA1.100kb.SNPs.GeneRegiononly.locus.pdf")
...
pdf("CAPZA1.1Mb.GRonly.locus.pdf")
...
pdf("CAPZA1.1Mb.GRonly.noannotation.locus.pdf")
